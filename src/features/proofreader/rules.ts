...
export const grammarRules: RegexRule[] = [
  {
    ...
    explanation:
      "This catches a common informal spelling that grammar tools flag.",
    pattern: /\balot\b/gi,
    replacement: "a lot",
    confidence: 0.98,
  },
...
export const styleRules: RegexRule[] = [
  {
    ...
    explanation:
      "Vale-style rules prefer direct adjectives over weak emphasis.",
    pattern:
      /\b(very|really|quite|basically|actually|literally|simply|just)\b/gi,
    replacement: "",
    confidence: 0.7,
  },
  {
  ...
  },
  {
    ...
    explanation:
      "Hedges are useful when true, but overuse can make writing less confident.",
...
export function regexSuggestions(
  text: string,
  rules: RegexRule[],
): Suggestion[] {
